...
return [
    ...
    'attributes' => [
        ...
        // Campos próprios da API, em camelCase como o front os envia.
        'active' => 'situação',
        'brand' => 'marca',
        'channel' => 'canal',
        'customerId' => 'cliente',
        'document' => 'documento',
        'intervalMileage' => 'intervalo em quilômetros',
        'intervalMonths' => 'intervalo em meses',
        'items.*.quantity' => 'quantidade do item',
        'items.*.serviceId' => 'serviço do item',
        'items.*.unitPrice' => 'valor unitário do item',
        ...
        'preferences.contactReminders' => 'lembretes de contato',
        'preferences.defaultReminderDays' => 'dias de antecedência do lembrete',
        'preferences.maintenanceAlerts' => 'alertas de manutenção',
        'preferences.weeklyReport' => 'relatório semanal',
        'result' => 'resultado',
        'users' => 'usuários',
        'users.*.active' => 'situação do usuário',
        'users.*.email' => 'e-mail do usuário',
        'users.*.name' => 'nome do usuário',
        'users.*.password' => 'senha do usuário',
        'users.*.role' => 'perfil do usuário',
        'vehicleId' => 'veículo',
        'whatsapp' => 'WhatsApp',
        'workshop' => 'oficina',
        'workshop.address' => 'endereço da oficina',
        'workshop.document' => 'CNPJ da oficina',
        'workshop.email' => 'e-mail da oficina',
        'workshop.name' => 'nome da oficina',
        'workshop.phone' => 'telefone da oficina',
        'workshop.whatsapp' => 'WhatsApp da oficina',
    ],
];
